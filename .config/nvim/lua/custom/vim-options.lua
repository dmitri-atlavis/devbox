...
map('n', '<Leader>s,', ':lua require("telescope.builtin").find_files({ hidden = true })<CR>', map_opts)
map('n', '<Leader><Leader>', ':lua require("telescope.builtin").buffers({ sort_lastused = true, ignore_current_buffer = true })<CR>', map_opts)
